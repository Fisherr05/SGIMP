              ...
              <div class="card-body">
                ...
                <form action="{{url_for('añadir_estudiante')}}" method="POST">
                  <div class="form-group">
                    <input type="text" class="form-control" name="cod_car" placeholder="Código de Carrera">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control" name="nombre-car" placeholder="Nombre de Carrera">
                  </div>
