...
FOREIGN KEY (CODIGO_ROL) REFERENCES ROLES(CODIGO_ROL) on update cascade on delete cacade,
PRIMARY KEY(CEDULA)
);
...
FOREIGN KEY (CEDULA) REFERENCES PERSONA(CEDULA)on update cascade on delete cacade,
PRIMARY KEY(CEDULA)
);
...
FOREIGN KEY (CODIGO_FACULTAD) REFERENCES FACULTAD(CODIGO_FACULTAD)on update cascade on delete cacade,
...
FOREIGN KEY (CEDULA) REFERENCES PERSONA(CEDULA)on update cascade on delete cacade,
FOREIGN KEY (CODIGO_CARRERA) REFERENCES CARRERA(CODIGO_CARRERA)on update cascade on delete cacade,
PRIMARY KEY(CEDULA)
);
...
FOREIGN KEY (CEDULA) REFERENCES PERSONA(CEDULA)on update cascade on delete cacade,
FOREIGN KEY (CODIGO_EMPRESA) REFERENCES EMPRESA(CODIGO_EMPRESA)on update cascade on delete cacade,
PRIMARY KEY(CEDULA)
);
...
FOREIGN KEY (CEDULA) REFERENCES COORDINADOR_GENERAL(CEDULA)on update cascade on delete cacade,
FOREIGN KEY (CODIGO_ESTADO) REFERENCES ESTADO (CODIGO_ESTADO)on update cascade on delete cacade /*trigger en esta tabla*/
);
...
FOREIGN KEY (CODIGO_PROYECTO) REFERENCES PROYECTO (CODIGO_PROYECTO)on update cascade on delete cacade, 
...
FOREIGN KEY (CODIGO_SUBPROYECTO) REFERENCES SUBPROYECTO (CODIGO_SUBPROYECTO)on update cascade on delete cacade,
...
FOREIGN KEY (CODIGO_COMPONENTE) REFERENCES COMPONENTE(CODIGO_COMPONENTE)on update cascade on delete cacade, 
...
FOREIGN KEY (CODIGO_COMPONENTE) REFERENCES COMPONENTE(CODIGO_COMPONENTE)on update cascade on delete cacade,
FOREIGN KEY (CEDULA_DOC) REFERENCES DOCENTE(CEDULA)on update cascade on delete cacade,
FOREIGN KEY (CEDULA_EST) REFERENCES ESTUDIANTE(CEDULA)on update cascade on delete cacade,
